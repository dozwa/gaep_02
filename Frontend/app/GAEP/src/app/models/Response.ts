...
/* SearchHistoryEntry: Datenmodell, das die SearchHistory-Einträge definiert.*/
// Datenmodell für die Einträge des Suchverlaufs
export interface SearchHistoryEntry {
  user_question: string;
  detail: 'detaillierte Antwort' | 'kurze Antwort';
}
